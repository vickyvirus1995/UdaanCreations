      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9 main-chart">
            <!--CUSTOM CHART START -->
<c:choose>
            <c:when test="${not empty SELECTEDPRODUCT.productId}">
                <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790" >
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Udaan Update Product Database</h2>
                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div>
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="productName" value ="${SELECTEDPRODUCT.productName}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div >
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="productQuantity" value ="${SELECTEDPRODUCT.productQuantity}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div >
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="productPrice" value ="${SELECTEDPRODUCT.productPrice}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div >
                                ...
                                <input type="hidden" value="${SELECTEDPRODUCT.productBase64Image}" name="oldProductImage"> 
                                </div>
                            </div>
                            <img style="padding-left: 5px;" src="data:image/jpg;base64,${SELECTEDPRODUCT.productBase64Image}" width="70px;" height="70px;">
                        </div>
                                                <div>
                            <button class="btn btn--radius-2 btn--red" type="submit">Update Product</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="products">
		<div class="container">
			...
			<div class="col-md-8 products-right">
				...
				<form action = "updateProductData" method="post">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											...
											<button type="submit"  style="font-size:16px;background-color: red;color:white;border: thick;width: 80px;margin-left: 32px;border-color: black;border-style: outset;font-weight:bold;">Edit</button>
