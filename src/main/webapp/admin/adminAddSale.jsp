                ...
                <div class="card-body" style="background: white; height:590px;">
                    <form method="POST" action="saveSaleData" enctype = "multipart/form-data">
                        ...
                        <div class="name">Discounted Price</div>
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="productDiscountedPrice">
                                </div></div>
                        <div class="form-row">
                            <div class="name">Special Offer</div>
                            <div>
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="productOffer" >
                                </div>
                            </div>
                        </div>
                                                <div>
                            <button class="btn btn--radius-2 btn--red" type="submit">Start Sale</button>
                        </div>
                    </form>
                </div>
            </div>
